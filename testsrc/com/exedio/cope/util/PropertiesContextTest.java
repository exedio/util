...
public class PropertiesContextTest
{
	...
	private static TestProperties getContext(final String raw)
	{
		...
		final TestProperties minimal = new TestProperties(pminimal, new AssertionErrorPropertiesSource(){
			...
			{
				return Collections.unmodifiableList(asList("x", "eimer", "wasser"));
			}
	...
	private static void assertContext(final String replaced, final String raw)
	{
